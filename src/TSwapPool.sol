...
contract TSwapPool is ERC20 {
    ...
    //@written-info events should be indexed if there are more than 3 parameters
    ...
    function deposit(
        ...
        // @written- IMPACT high, Likelihood- HIGH deadline not being used
        uint64 deadline
    )
        external
        revertIfZero(wethToDeposit)
        returns (
            // you should add this line of code  revertIfDeadlinePassed(deadline)
    ...
    {
        //@written high the users will be charged way too much
    ...
    function swapExactInput(
        ...
        //@reported-info this should be external
        public
        revertIfZero(inputAmount)
        revertIfDeadlinePassed(deadline)
        returns (
    ...
    function swapExactOutput(
        ...
        IERC20 outputToken,
        uint256 outputAmount,
        // @written a user may get a WAY worse swap
        uint64 deadline
    )
        public
        revertIfZero(outputAmount)
    ...
    // @audit this breaks the invariant and can be exploited
